...
MONGODB_LOGS_SIZE = 16777216  # If provided, sets the log collection to capped to that amount of bytes.
NO_MONGODB_ENSURE_INDEXES = False  # If provided, skip the creation of MongoDB indexes at worker startup.
...
DASHBOARD_IP = "127.0.0.1"  # Bind the dashboard to this IP. Default is 0.0.0.0, use 127.0.0.1 to restrict access.
